        ...
        <fetcher.Form ref={formRef} method="post" className="space-y-10">
          ...
          <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-12">
            ...
            <div className="space-y-2 md:col-span-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setTotalOrgMembers(sanitizeIntegerInput(e.target.value))
                }
                style={{ color: "#171717" }}
          ...
          <div className="space-y-8">
            {proponents.map((proponent, index) => (
              <div
                key={proponent.id}
                className="space-y-6 rounded-2xl border border-neutral-200/80 bg-white/60 p-6 shadow-xs"
              >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-12">
                  <div className="space-y-1.5 md:col-span-4">
                    ...
                    <Input
                      ...
                      style={{ color: "#171717" }}
                      className="h-9.5 rounded-lg border-neutral-300 bg-white !text-neutral-900 placeholder:text-neutral-400"
                      required
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      style={{ color: "#171717" }}
                      className="h-9.5 cursor-pointer rounded-lg border-neutral-300 bg-white px-3 !text-neutral-900"
                      required
                    />
                  </div>
                </div>
                    ...
                    >
                      ...
                      >
                        <SelectItem
                          ...
                          className="cursor-pointer rounded-lg px-3 py-2 text-sm text-neutral-900 data-[highlighted]:bg-neutral-100 data-[highlighted]:text-neutral-900 data-[state=checked]:font-semibold data-[state=checked]:text-neutral-900"
                        >
                        ...
                        <SelectItem
                          ...
                          className="cursor-pointer rounded-lg px-3 py-2 text-sm text-neutral-900 data-[highlighted]:bg-neutral-100 data-[highlighted]:text-neutral-900 data-[state=checked]:font-semibold data-[state=checked]:text-neutral-900"
                        >
                          School of Civil, Environmental & Geo Engineering
                          (CEGE)
                        </SelectItem>
                        <SelectItem
          ...
          <div className="space-y-6 pt-4">
            <div className="border-b border-neutral-200 pb-2">
              <h2 className="text-base font-bold tracking-wide text-neutral-900 uppercase">
                ALIGNMENT WITH INSTITUTIONAL VISION, MISSION AND FORMATION
                GOALS:
              </h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pl-1">
                <label className="flex cursor-pointer items-start gap-3 text-sm leading-snug text-neutral-800 select-none">
                  <input
                    type="checkbox"
                    checked={mission1}
                        ...
                        <tr key={item.id} className="hover:bg-neutral-50/60">
                          <td className="border-r border-neutral-300 p-2">
                            <input
                              ...
                              className="w-full rounded border border-transparent bg-transparent px-2 py-1 text-center !text-neutral-900 focus:border-neutral-300 focus:bg-white focus:outline-none"
                            />
                          </td>
                          ...
                          <td className="border-r border-neutral-300 p-2">
                            <div className="flex items-center justify-center gap-1">
                              <span className="font-semibold text-neutral-500 select-none">
                                ₱
                              </span>
                              <input
                                type="number"
          ...
          >
            ...
            <div className="flex flex-1 flex-col justify-center space-y-5 px-8 py-5 text-center">
              <p className="text-sm leading-relaxed font-normal text-neutral-700">
                This action will submit your student activity form with the data
                you have inputted.{" "}
