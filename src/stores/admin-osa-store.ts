...
function computeMetrics(
  ...
  return {
    activeOrganizations:
      orgCount > 0
        ? activeCount + newRegs + (orgCount - activeCount - newRegs)
        : 0,
...
const MOCK_ORGANIZATIONS: Organization[] = [
  {
    PK: "ORGANIZATION#org-001",
    SK: "ORGANIZATION#org-001",
    name: "Alpha Student Org",
  },
  {
    PK: "ORGANIZATION#org-002",
    SK: "ORGANIZATION#org-002",
    name: "Beta Tech Guild",
  },
  {
    PK: "ORGANIZATION#org-003",
    SK: "ORGANIZATION#org-003",
    name: "Gamma Drama Club",
  },
  {
    PK: "ORGANIZATION#org-004",
    SK: "ORGANIZATION#org-004",
    name: "Delta Athletic Club",
  },
]

const MOCK_SIGNATORIES: Signatory[] = [
  {
    PK: "SIGNATORY#sig-010",
    SK: "SIGNATORY#sig-010",
    name: "Prof. Alan Vance",
    GSI4PK: "ROLE#ADVISER#ORG#org-001",
    GSI4SK: "sig-010",
  },
  {
    PK: "SIGNATORY#sig-011",
    SK: "SIGNATORY#sig-011",
    name: "Dr. Clara Miles",
    GSI4PK: "ROLE#ADVISER#ORG#org-002",
    GSI4SK: "sig-011",
  },
  {
    PK: "SIGNATORY#sig-012",
    SK: "SIGNATORY#sig-012",
    name: "Prof. Jack Geller",
    GSI4PK: "ROLE#ADVISER#ORG#org-003",
    GSI4SK: "sig-012",
  },
  {
    PK: "SIGNATORY#sig-013",
    SK: "SIGNATORY#sig-013",
    name: "Coach Mike Tyson",
    GSI4PK: "ROLE#ADVISER#ORG#org-004",
    GSI4SK: "sig-013",
  },
]
    ...
    proponents: [
      {
        ...
        program_and_year: "BSIT-4",
        date_of_submission: "2026-09-10",
        department: "CCIS",
        position_of_applicant: "President",
        org_or_course_section: "Alpha Student Org",
        contact_number: "09171234567",
        email_address: "kyle.rogers@mapua.edu.ph",
        facebook_link: "",
      },
    ],
    activity_details: {
      title_and_nature: "Annual Hackathon & Innovation Expo",
      description: "University-wide hackathon",
      objectives: "Foster innovation among students",
      venue: "Main Auditorium",
      date_of_event: "2026-10-15",
      day_of_event: "Thursday",
      time_of_event: "08:00",
...
const MOCK_ANNOUNCEMENTS: Announcement[] = [
  {
    id: "ann-1",
    title: "AY 2026-2027 Registration Open",
    date: "Sep 01, 2026",
    time: "8:00 AM",
  },
  {
    id: "ann-2",
    title: "SAAF Submission Deadline Extended",
    date: "Sep 05, 2026",
    time: "12:00 PM",
  },
  {
    id: "ann-3",
    title: "New Venue Reservation Policy",
    date: "Sep 08, 2026",
    time: "3:30 PM",
  },
  {
    id: "ann-4",
    title: "Mid-term Activity Freeze Period",
    date: "Sep 12, 2026",
    time: "9:00 AM",
  },
]
...
const MOCK_AUDIT_LOGS: AuditLogEntry[] = [
  {
    ...
    actor: "Kyle Rogers",
    description: "Submitted SAAF for 'Annual Hackathon & Innovation Expo'",
    orgId: "org-001",
  },
  {
    id: "log-002",
    ...
    actor: "Prof. Alan Vance",
    description: "Approved submission SUB-200 (Adviser sign-off)",
    orgId: "org-001",
  },
  {
    id: "log-003",
    ...
    actor: "System Admin",
    description:
      "Organization status changed from 'Pending Registration' to 'Active'",
    orgId: "org-002",
  },
  {
    id: "log-004",
    ...
    actor: "Dr. Clara Miles",
    description: "Returned submission SUB-198 — missing budget breakdown",
    orgId: "org-002",
  },
  {
    id: "log-005",
    ...
    actor: "System Admin",
    description: "Updated adviser assignment to Prof. Jack Geller",
    orgId: "org-003",
  },
  {
    id: "log-006",
    ...
    actor: "OSA Admin",
    description: "Created announcement: 'AY 2026-2027 Registration Open'",
  },
  {
    id: "log-007",
    timestamp: "2026-09-08T15:30:00Z",
    action: "submission_created",
    actor: "Marcus Aurelius",
    description: "Submitted SAAF for 'Drama Festival & Workshop Series'",
    orgId: "org-003",
  },
  {
    id: "log-008",
    ...
    actor: "System Admin",
    description:
      "Organization status changed to 'Inactive' — no active officers",
    orgId: "org-004",
  },
  {
    id: "log-009",
    ...
    action: "submission_approved",
    actor: "Dean Martinez",
    description: "Final approval for submission SUB-195 (Dean sign-off)",
    orgId: "org-001",
  },
  {
    id: "log-010",
    ...
    action: "account_updated",
    actor: "Sarah Jenkins",
    description: "Updated organization profile and contact information",
    orgId: "org-004",
  },
]
